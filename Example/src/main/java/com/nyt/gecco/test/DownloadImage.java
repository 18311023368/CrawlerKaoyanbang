...
//	private static Log log = LogFactory.getLog(com.geccocrawler.gecco.utils.DownloadImage.class);
...
//			log.error("image download error :"+imgUrl);
	...
	public static void main(String[] args) {
		System.out.println(com.geccocrawler.gecco.utils.DownloadImage.download("d:\\", "http://git.oschina.net/uploads/78/666978_xtuhcy.jpg?1459474621"));
	}
}
